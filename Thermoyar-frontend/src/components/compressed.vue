        ...
        <div class="calculator-section">
            ...
            <div class="inputs">
                <div class="temperature">
                    ...
                    <input type="text" name="temperature" placeholder=" دما رو وارد کن" v-model="temperature">
                </div>
                <div class="pressure">
                    ...
                    <select name="wanted" v-model="pressure">
                        ...
                        <option :value="pressure" v-for="pressure in compressedPressures" :key="pressure">{{ pressure }}</option>
                    </select>
                </div>
            </div>
...
export default {
    ...
    methods:{
        calculate: function(){
            ...
            if(this.robotIsNotInPage()){
                ...
                axios.post('http://thermoyar.ir/api/v1/sub_cold/', data).then( res => {
                    this.loading = false;
    ...
    computed:{
        ...
        compressedPressures(){
            return this.$store.state.pressures[this.selectedMaterial-1].compressedPressures;
        }
    },
}
</script>
